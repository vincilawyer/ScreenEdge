...
struct Preferences: Codable {
    ...
    init() {}
    enum CodingKeys: String, CodingKey { case enabled, automatic, automaticUniversalControl, nearOnly, showMenuBarIcon, showWhenLocked, alwaysShowWhenLocked, thickness, markers }
