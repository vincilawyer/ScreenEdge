...
xcrun swiftc -swift-version 5 -O -target "${SCREENEDGE_ARCH:-arm64}-apple-macosx13.0" -module-cache-path "$PWD/.build/module-cache" Sources/*.swift -o "$APP/Contents/MacOS/ScreenEdge" -framework AppKit -framework SwiftUI -framework ServiceManagement
